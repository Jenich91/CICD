...
#############
./sfleta_cat -e input.txt input3.txt input2.txt > sfleta_cat_out
cat -e input.txt input3.txt input2.txt > cat_out

if cmp -s cat_out sfleta_cat_out ; then
...
# ##############
./sfleta_cat -s input.txt input3.txt input2.txt > sfleta_cat_out
...
# ##############
./sfleta_cat -t input.txt input3.txt input2.txt > sfleta_cat_out
...
##############
./sfleta_cat -e -s input.txt input3.txt input2.txt > sfleta_cat_out
...
#############
./sfleta_cat -e -t input.txt input3.txt input2.txt > sfleta_cat_out
...
############
./sfleta_cat -s -t input.txt input3.txt input2.txt > sfleta_cat_out
